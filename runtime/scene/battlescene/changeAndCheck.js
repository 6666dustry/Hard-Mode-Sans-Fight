...
function changeAndCheck(Scene, Target, Tween, changing) {
...
export default function setTarget(Scene, Target, Tween, changing) {
    ...
    if (Array.isArray(TWEENS)) {
        for (const iterator of TWEENS) {
            changeAndCheck(Scene, Target, iterator, changing);
        }
    }
    else {
        changeAndCheck(Scene, Target, TWEENS, changing);
    }
}
//# sourceMappingURL=changeAndCheck.js.map